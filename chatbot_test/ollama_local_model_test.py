...
And, 당신은 질문에 친절하게 답변하는AI 입니다. 
검색된 다음 문맥을 사용하여 질문에 답하세요. 답을 모른다면 모른다고 답변하세요.

The following is additional information about the {domain}.
'''
Port-MIS(항만운영정보시스템, Port Management Information System)는 전국의 31개 무역항에 대하여 선박의 입항신고, 항만 내 시설사용, 관제사항, 화물반출입, 세입징수, 출항신고 등 모든 항만운영업무 및 민원업무를 처리하는 시스템입니다.
'''
#Format:
Question: "월정료선박 사용신청을 할 때 1년 선납시 어떤 혜택을 받을 수 있습니까?"
Context: "월정료선박 사용신청을 할 때 1년 선납시 사용료 10%를 할인받을 수 있습니다."
'''
...
st.set_page_config(page_title="PORT-MIS Chatbot Test(OLLAMA Local 모델)", page_icon="💬")
st.title("PORT-MIS Chatbot(Test)")


if "messages" not in st.session_state:
    st.session_state["messages"] = [
        ChatMessage(role="assistant", content="안녕하세요! \n저는 해운항만물류정보시스템 (PORT-MIS) 안내 도우미예요.😊 \n무엇을 도와드릴까요?")
    ]
